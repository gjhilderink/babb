@extends('layouts.app')
@section('title', $product->name . ' â€” BABB Portaal')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <dl class="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
        <div><dt class="text-gray-500">SKU</dt><dd class="font-mono font-medium mt-1">{{ $product->sku ?? 'â€”' }}</dd></div>
        <div><dt class="text-gray-500">Categorie</dt><dd class="font-medium mt-1">{{ $product->category ?? 'â€”' }}</dd></div>
