@extends('layouts.app')
@section('title', 'Nieuwe vergadering – BABB Portaal')

@section('content')
<div class="mb-6 flex items-center gap-3">
    <a href="{{ route('meetings.index') }}" class="text-gray-400 hover:text-gray-700 text-sm">&larr; Vergaderingen</a>
    <h1 class="text-2xl font-bold text-gray-900">Nieuwe vergadering</h1>
</div>
...
<form method="POST" action="{{ route('meetings.store') }}">
    ...
    <div class="mt-6 flex items-center gap-3">
        ...
        <a href="{{ route('meetings.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Annuleren</a>
    </div>
</form>
@endsection
