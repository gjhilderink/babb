        ...
        <div class="flex gap-4 items-start">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-4 text-sm text-gray-500">
                    ...
                    @endif
                    @if ($event->budget || $event->costs->count() > 0)
                    <span class="flex items-center gap-1">
                        ...
                        @if ($event->budget)
                            <span title="Begroting">&euro;&nbsp;{{ number_format($event->budget, 2, ',', '.') }}</span>
                            @if ($event->costs->count() > 0)
                                <span class="text-gray-400">/</span>
                                <span title="Werkelijke kosten" class="{{ $event->totalCosts() > $event->budget ? 'text-red-500 font-medium' : 'text-green-600' }}">
